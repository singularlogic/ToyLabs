<template>
    <div id="collaborations">
        <div class="ui pointing secondary orange menu">
            ...
            <router-link :to="{ name: 'discussionview', params: { id, type, org_id: organization.id } }" v-if="organization" class="item">{{ organization.name }}</router-link>
        </div>
...
export default {
    ...
    created() {
        ...
        const routes = [
            { name: 'overview', path: `${baseUrl}/`, component: Overview, props: { type: this.type, id: this.id } },
