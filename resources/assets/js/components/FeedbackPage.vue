<template>
    <div id="collaborations">
        <div class="ui pointing secondary orange menu">
            ...
            <router-link :to="{ name: 'feedbackview', params: { id, type, org_id: organization.id } }" v-if="organization" class="item">{{ organization.name }}</router-link>
        </div>
...
export default {
    ...
    created() {
        ...
        const routes = [
            ...
            { name: 'feedbackview', path: `/:type/:id/feedback/:org_id`, component:  Contact },
        ];
