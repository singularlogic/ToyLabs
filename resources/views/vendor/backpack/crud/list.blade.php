...
@section('after_scripts')
	...
	<script type="text/javascript">
      ...
      function register_delete_button_action() {
        ...
        $("[data-button-type=ignore]").unbind('click');
        // CRUD Delete
        ...
        $("[data-button-type=ignore]").click(function(e) {
          e.preventDefault();
          var ignore_button = $(this);
          var ignore_url = $(this).attr('href');

          if (confirm("Are you sure you want to ignore this report?") == true) {
              $.ajax({
                  url: ignore_url,
                  type: 'put',
                  success: function(result) {
                      ...
                      new PNotify({
                          ...
                          text: "The report on this comment is ignored!",
                          type: "success"
                      });
                      // ignore the row from the table
                      ignore_button.parentsUntil('tr').parent().remove();
                  },
                  error: function(result) {
                      // Show an alert with the result
                      new PNotify({
                          title: "Ignoring failed",
                          text: "An error occured and we didn't manage to ignore this comment",
                          type: "warning"
                      });
                  }
              });
              ...
              new PNotify({
                  title: "Ignore cancelled",
                  text: "No changes were made to this report",
                  type: "info"
              });
          }
        });
