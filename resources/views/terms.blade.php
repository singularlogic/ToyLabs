...
@section('content')
        ...
        <div class="ui main container">
            <h1 class="ui dividing header">{{ __('Terms & Conditions') }}</h1>

            <p>These terms and conditions outline the rules and regulations for the use of ToyLabs's Website. By accessing this website, we assume you accept these terms and conditions in full. Do not continue to use ToyLabs' website if you do not accept all of the terms and conditions stated on this page.</p>
            ...
            <h3>Cookies</h3>
            <p>We employ the use of cookies. By using ToyLabs's website you consent to the use of cookies in accordance with ToyLabs’s privacy policy. Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate / advertising partners may also use cookies.</p>

            <h3>License</h3>
            <p>Unless otherwise stated, ToyLabs and/or it’s licensors are not owners of the intellectual property rights for any material on ToyLabs. All intellectual property rights are reserved. You may view and/or print pages from <a href="https://platform.toylabs.eu">https://platform.toylabs.eu</a> for your own personal use subject to restrictions set in these terms and conditions.</p>

            <p>If you are not the owner you must <strong>not</strong>:</p>

            <ul>
                <li>Republish material from <a href="https://platform.toylabs.eu">https://platform.toylabs.eu</a></li>
                <li>Sell, rent or sub-license material from <a href="https://platform.toylabs.eu">https://platform.toylabs.eu</a></li>
                <li>Reproduce, duplicate or copy material from <a href="https://platform.toylabs.eu">https://platform.toylabs.eu</a></li>
                <li>Redistribute content from ToyLabs (unless content is specifically made for redistribution).</li>
            </ul>
            ...
            <p>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. ToyLabs does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of ToyLabs, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws ToyLabs shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

            <p>ToyLabs reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</p>
            ...
            <p>These organizations may link to our home page or Public content in the Web site so long as the link: (a) is not in any way misleading; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party's site.</p>

            <p>We may consider and approve in our sole discretion other link requests from the following types of organizations:</p>

            <ul>
                <li>commonly-known consumer and/or business information sources such as Chambers of Commerce, American Automobile Association, AARP and Consumers Union; dot.com community sites;</li>
            ...
            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to {{ Html::mailto('toylabs@aiju.info') }}.</p>
	        ...
	        <p><strong>No use of ToyLabs’ logo or other artwork will be allowed for linking absent a trademark license agreement.</strong></p>
            ...
            <ul>
                ...
                <li>exclude any responsibility about IPR infractions between partners</li>
            </ul>
            ...
            <p> When you use our services or view content provided by ToyLabs, we automatically collect and store certain information. We use the information we collect from all of our services to provide, maintain, protect and improve them, to develop new ones and to protect Google and our users. We also use this information to offer you tailored content – like giving you more relevant search results and ads.</p>
        </div>
@endsection
